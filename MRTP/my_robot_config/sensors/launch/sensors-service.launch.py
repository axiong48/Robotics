...
def generate_launch_description():
    ...
    launch_file_lidar2d_0 = '/MRTP/MRTP/my_robot_config/sensors/launch/lidar2d_0.launch.py'
    launch_file_lidar3d_0 = '/MRTP/MRTP/my_robot_config/sensors/launch/lidar3d_0.launch.py'
    launch_file_camera_0 = '/MRTP/MRTP/my_robot_config/sensors/launch/camera_0.launch.py'
